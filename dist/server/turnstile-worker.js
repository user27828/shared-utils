 ...
 */
import { verifyTurnstileTokenEnhanced, getAllowedOrigin, } from "./src/turnstile/index.js";
export default {
    async fetch(request, env) {
        ...
        try {
            ...
            const verifyResult = await verifyTurnstileTokenEnhanced(body.token, env.TURNSTILE_SECRET_KEY, remoteip, body.idempotencyKey, {
