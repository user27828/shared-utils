...
export const extractEmailAddress = (value: unknown): string | undefined => {
...
export const normalizeEmailAddressValue = (
  email: unknown,
...
const normalizeEmailDisplayName = (
  name: unknown,
...
export const formatEmailAddress = (address: EmailAddressLike): string => {
