                                ...
                                setPreviewMode(v);
                                    ...
                                    return (_jsxs(TableRow, { hover: true, selected: isExternallySelected || isMultiSelected, sx: { cursor: "pointer" }, onClick: () => openDetail(f.uid), children: [enableBulkActions && (_jsx(TableCell, { padding: "checkbox", onClick: (e) => e.stopPropagation(), children: isRenameSubmitting ? (_jsx(CircularProgress, { size: 16, thickness: 5 })) : (_jsx(Checkbox, { size: "small", checked: isMultiSelected, onChange: () => toggleSelected(f.uid) })) })), _jsx(TableCell, { children: _jsxs(Stack, { direction: "row", spacing: 1.5, sx: { alignItems: "center" }, children: [_jsx(Box, { sx: {
                                                                ...
                                                                flexShrink: 0,
                                                                    ...
                                                                    alignItems: "center",
                                                                    gap: 0.25,
                                                                }, children: [_jsx(InsertDriveFileOutlinedIcon, { sx: { fontSize: 22, color: "text.secondary" } }), _jsx(Typography, { variant: "caption", color: "text.secondary", sx: { fontSize: "0.65rem", fontWeight: 700 }, children: getFileExtLabel(f) })] })) }), _jsxs(Box, { sx: { minWidth: 0 }, children: [_jsxs(Stack, { direction: "row", spacing: 0.5, sx: { minWidth: 0, alignItems: "center" }, children: [!isRenaming && (_jsxs(_Fragment, { children: [_jsx(Typography, { noWrap: true, title: getFileLabel(f), sx: { minWidth: 0, fontWeight: 700 }, children: getFileLabel(f) }), isRenameSubmitting ? (_jsx(Tooltip, { title: "Renaming...", children: _jsx(CircularProgress, { size: 16, thickness: 5 }) })) : (_jsx(Tooltip, { title: "Rename", children: _jsx(IconButton, { size: "small", disabled: Boolean(renameSubmittingUid), onClick: (e) => {
                                                                                            stop(e);
                                                                                ...
                                                                                nextName: renameText,
                                                                                source: "list",
                                                                            }), onCancel: cancelInlineRename, isSubmitting: isRenameSubmitting }))] }), _jsxs(Typography, { variant: "caption", color: "text.secondary", noWrap: true, sx: { display: "block" }, title: `${f.mime_type} | ${f.uid}`, children: [f.mime_type, " | ", f.uid] }), _jsxs(Stack, { direction: "row", spacing: 0.5, sx: { mt: 0.5, flexWrap: "wrap" }, children: [f.is_public && (_jsx(Chip, { label: "Public", size: "small", variant: "outlined" })), f.archived_at && (_jsx(Chip, { label: "Archived", size: "small", variant: "outlined" }))] })] })] }) }), _jsx(TableCell, { children: _jsx(Typography, { variant: "body2", noWrap: true, children: formatCreatedAt(f.created_at) }) }), _jsx(TableCell, { align: "right", children: _jsx(Typography, { variant: "body2", children: formatBytes(f.byte_size) }) }), _jsx(TableCell, { onClick: (e) => e.stopPropagation(), children: _jsxs(Stack, { direction: "column", spacing: 0.5, children: [props.onSelect && (_jsx(FmSelectButton, { file: f, api: api, onSelect: props.onSelect })), _jsx(FmFileActionIcons, { file: f, api: api, onOpenDetail: openDetail, onDelete: handleDeleteInline })] }) })] }, f.uid));
                                ...
                                if (e.key === "Enter" || e.key === " ") {
                                    ...
                                    openDetail(f.uid);
                                        ...
                                        isSupportedVideoMime(f.mime_type) ? (_jsxs(_Fragment, { children: [_jsx(Box, { component: "video", preload: "metadata", controls: true, onClick: (e) => e.stopPropagation(), sx: {
                                                    ...
                                                    }, children: _jsx(PictureInPictureAltIcon, { sx: { fontSize: 16 } }) }) })] })) : (_jsxs(Box, { sx: {
                                            display: "flex",
                                            flexDirection: "column",
                                            alignItems: "center",
                                            gap: 0.5,
                                            textAlign: "center",
                                        }, children: [_jsx(InsertDriveFileOutlinedIcon, { sx: { fontSize: 40, color: "text.secondary" } }), _jsx(Typography, { variant: "caption", color: "text.secondary", sx: { fontWeight: 700 }, children: getFileExtLabel(f) })] })) }), !isRenaming ? (_jsxs(Stack, { direction: "row", spacing: 0.5, sx: { minWidth: 0, alignItems: "center" }, children: [_jsx(Typography, { noWrap: true, title: getFileLabel(f), sx: { minWidth: 0, flex: 1, fontWeight: 700 }, children: getFileLabel(f) }), isRenameSubmitting ? (_jsx(CircularProgress, { size: 16, thickness: 5 })) : (_jsx(Tooltip, { title: "Rename", children: _jsx(IconButton, { size: "small", disabled: Boolean(renameSubmittingUid), onClick: (e) => {
                                                    stop(e);
                                                    setRenamingUid(f.uid);
                                                    setRenameText(getFileLabel(f));
                                            ...
                                            nextName: renameText,
                                            source: "list",
                                        }), onCancel: cancelInlineRename, isSubmitting: isRenameSubmitting, compact: true }) })), props.onSelect && (_jsx(Box, { onClick: (e) => stop(e), children: _jsx(FmSelectButton, { file: f, api: api, onSelect: props.onSelect }) })), _jsxs(Stack, { direction: "row", spacing: 0.5, sx: { flexWrap: "wrap", alignItems: "center" }, children: [f.is_public && (_jsx(Chip, { label: "Public", size: "small", variant: "outlined" })), f.archived_at && (_jsx(Chip, { label: "Archived", size: "small", variant: "outlined" })), _jsx(Chip, { label: formatBytes(f.byte_size), size: "small", variant: "outlined" }), _jsx(Box, { sx: { ml: "auto", flexShrink: 0 }, onClick: (e) => stop(e), children: _jsx(FmFileActionIcons, { file: f, api: api, onOpenDetail: openDetail, onDelete: handleDeleteInline }) })] })] }, f.uid));
                    }), !isLoading && items.length === 0 && (_jsx(Typography, { color: "text.secondary", sx: { py: 2 }, children: "No files found." }))] })), _jsxs(Stack, { direction: "row", spacing: 1, sx: { mt: 1.5, alignItems: "center" }, children: [_jsx(Button, { size: "small", variant: "outlined", onClick: () => setOffset(Math.max(0, offset - limit)), disabled: isLoading || offset <= 0, children: "Prev" }), _jsx(Button, { size: "small", variant: "outlined", onClick: () => setOffset(offset + limit), disabled: isLoading || offset + limit >= totalCount, children: "Next" }), _jsx(FormControl, { size: "small", sx: { minWidth: 70 }, children: _jsx(Select, { value: itemsPerPage, onChange: (e) => {
                                const v = Number(e.target.value);
                                if (v > 0) {
                                    setItemsPerPage(v);
                                    setOffset(0);
                                }
                            }, children: PAGE_SIZES.map((s) => (_jsx(MenuItem, { value: s, children: s }, s))) }) }), _jsxs(Typography, { variant: "body2", color: "text.secondary", sx: { ml: "auto" }, children: [pageInfo.start, "-", pageInfo.end, " of ", pageInfo.totalCount] })] }), _jsxs(Drawer, { anchor: "right", open: Boolean(activeUid), onClose: closeDetail, slotProps: {
                    backdrop: { sx: { zIndex: 1400 } },
                    paper: { sx: { width: "min(520px, 100vw)", p: 2, zIndex: 1400 } },
                }, sx: { zIndex: 1400 }, children: [_jsxs(Stack, { direction: "row", spacing: 1, sx: { alignItems: "center" }, children: [!detailIsRenaming && (_jsxs(_Fragment, { children: [_jsx(Typography, { noWrap: true, title: activeFile ? getFileLabel(activeFile) : activeUid || "", sx: { flex: 1, minWidth: 0, fontWeight: 800 }, children: activeFile ? getFileLabel(activeFile) : activeUid }), activeFile &&
                                        (renameSubmittingUid === activeFile.uid ? (_jsx(Tooltip, { title: "Renaming...", children: _jsx(CircularProgress, { size: 16, thickness: 5 }) })) : (_jsx(Tooltip, { title: "Rename", children: _jsx(IconButton, { size: "small", disabled: Boolean(renameSubmittingUid), onClick: (e) => {
                                                ...
                                                }, children: _jsx(EditOutlinedIcon, { fontSize: "small" }) }) })))] })), detailIsRenaming && activeFile && (_jsxs(Stack, { direction: "row", spacing: 0.5, sx: { flex: 1, minWidth: 0, alignItems: "center" }, children: [_jsx(TextField, { size: "small", value: detailRenameText, disabled: renameSubmittingUid === activeFile.uid, autoFocus: true, fullWidth: true, onClick: (e) => stop(e), onChange: (e) => setDetailRenameText(e.target.value), onKeyDown: (e) => {
                                            if (e.key === "Escape") {
                                            ...
                                            }, children: renameSubmittingUid === activeFile.uid ? (_jsx(CircularProgress, { size: 16, thickness: 5 })) : (_jsx(CheckOutlinedIcon, { fontSize: "small" })) }) })] })), _jsx(Button, { variant: "outlined", onClick: closeDetail, children: "Close" })] }), activeLoading && _jsx(LinearProgress, { sx: { mt: 1.5 } }), activeError && (_jsx(Alert, { severity: "error", sx: { mt: 1.5 }, children: activeError })), activeFile && (_jsxs(Stack, { spacing: 2, sx: { mt: 2 }, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "caption", color: "text.secondary", children: "UID" }), _jsxs(Stack, { direction: "row", spacing: 1, sx: { mt: 0.25, alignItems: "center" }, children: [_jsx(Typography, { variant: "body2", sx: { wordBreak: "break-all", fontFamily: "monospace" }, children: activeFile.uid }), _jsx(CopyButton, { value: activeFile.uid, tooltip: "Copy UID", size: "small", iconFontSize: "small" })] })] }), _jsxs(Box, { children: [_jsx(Typography, { variant: "caption", color: "text.secondary", children: "Preview" }), _jsxs(Paper, { variant: "outlined", sx: {
                                            mt: 1,
                                            p: 1.5,
                                            borderRadius: 2,
                                            bgcolor: "action.hover",
                                                ...
                                                (!isImageMime(activeFile.mime_type) &&
                                                    !isSupportedVideoMime(activeFile.mime_type))) && (_jsxs(Typography, { color: "text.secondary", variant: "body2", children: ["No inline preview available for", " ", activeFile.mime_type || "this file", "."] }))] }), _jsxs(Stack, { direction: "row", spacing: 1, sx: { mt: 1, flexWrap: "wrap" }, children: [_jsx(CopyButton, { value: api.getContentUrl({ fileUid: activeFile.uid }), tooltip: "Copy URL", size: "small", iconFontSize: "small" }), _jsx(Button, { size: "small", variant: "outlined", component: "a", href: api.getContentUrl({
                                                    fileUid: activeFile.uid,
                                                    download: true,
                                                }), target: "_blank", rel: "noopener noreferrer", children: "Download" }), activeUrlKind && (_jsx(Chip, { label: `URL: ${activeUrlKind}`, size: "small" }))] })] }), _jsxs(Box, { children: [_jsx(Typography, { sx: { fontWeight: 800 }, children: "Metadata" }), _jsxs(Stack, { spacing: 1.5, sx: { mt: 1 }, children: [_jsx(TextField, { size: "small", label: "Title", value: safeStr(activeFile.title), onChange: (e) => setActiveFile({
                                                    ...activeFile,
                                                    ...
                                                    alt_text: e.target.value,
                                                        ...
                                                        })(), children: "Save" }), _jsx(Button, { variant: "outlined", onClick: () => void loadDetail(), children: "Reload" })] })] })] }), _jsxs(Box, { children: [_jsx(Typography, { sx: { fontWeight: 800 }, children: "Actions" }), _jsxs(Stack, { direction: "row", spacing: 1, sx: { mt: 1, flexWrap: "wrap" }, children: [!activeFile.archived_at && (_jsx(Button, { variant: "outlined", onClick: () => void (async () => {
                                                    ...
                                                    await reload();
                                                    closeDetail();
                                                })(), children: "Delete" })] })] }), _jsxs(Box, { children: [_jsx(Typography, { sx: { fontWeight: 800 }, children: "Move" }), _jsx(MoveForm, { fileUid: activeFile.uid, onMove: async (toBucket, toFolderPath) => {
                                            await api.moveFile({
                                                fileUid: activeFile.uid,
                                                toBucket,
                                                toFolderPath,
                                            ...
                                            await reload();
                                            await loadDetail();
                                        } })] }), _jsxs(Box, { children: [_jsxs(Stack, { direction: "row", spacing: 1, sx: { alignItems: "center" }, children: [_jsx(Typography, { sx: { fontWeight: 800 }, children: "Where used" }), _jsx(Button, { size: "small", sx: { ml: "auto" }, onClick: () => void loadLinks(), children: "Refresh" })] }), linksLoading && _jsx(LinearProgress, { sx: { mt: 1 } }), linksError && (_jsx(Alert, { severity: "error", sx: { mt: 1 }, children: linksError })), _jsx(CreateLinkForm, { onCreate: async (linkedEntityType, linkedEntityUid, linkedField) => {
...
const FmFileActionIcons = ({ file, api, onOpenDetail, onDelete }) => (_jsxs(Stack, { direction: "row", spacing: 0.5, sx: { alignItems: "center" }, children: [_jsx(CopyButton, { value: api.getContentUrl({ fileUid: file.uid }), tooltip: "Copy URL", size: "small", iconFontSize: "small" }), _jsx(Tooltip, { title: "Details", children: _jsx(IconButton, { size: "small", onClick: () => onOpenDetail(file.uid), children: _jsx(InfoOutlinedIcon, { fontSize: "small" }) }) }), _jsx(Tooltip, { title: "Delete", children: _jsx(IconButton, { size: "small", sx: { color: "error.main" }, onClick: () => void onDelete(file), children: _jsx(DeleteOutlinedIcon, { fontSize: "small" }) }) })] }));
/**
