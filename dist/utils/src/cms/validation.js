 ...
 */
import { CmsContentTypeSchema, CmsPostTypeSchema, CmsStatusSchema, } from "./types.js";
 ...
 */
export const canonicalizeSlug = (raw) => {
    return String(raw || "")
        .trim()
        .toLowerCase()
        .replace(/[\s_]+/g, "-")
 ...
 */
export const assertValidSlug = (slug, reservedSlugs = []) => {
    if (!isValidSlug(slug)) {
 ...
 * @throws CmsValidationError
 */
export const assertAllowedContentType = (contentType) => {
 ...
 * @throws CmsValidationError
 */
export const assertAllowedPostType = (postType) => {
 ...
 * @throws CmsValidationError
 */
export const assertAllowedStatus = (status) => {
