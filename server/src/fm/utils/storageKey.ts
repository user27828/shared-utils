 ...
 */
const assertValidObjectKey = (objectKey: string): void => {
 ...
 */
export const encodeFmStorageKey = (ref: FmObjectRef): string => {
 ...
 */
export const decodeFmStorageKey = (storageKey: string): FmObjectRef => {
 ...
 */
export const tryDecodeFmStorageKey = (
  storageKey: string,
): FmObjectRef | null => {
  try {
