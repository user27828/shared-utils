...
exports.ethnicityOptions = [
    { value: "Latina/Latino or Hispanic", label: "Latina/Latino or Hispanic" },
    {
        ...
        label: "Not Latina/Latino or Hispanic",
    },
    { value: "Prefer Not to Answer", label: "Prefer Not to Answer" },
];
exports.raceOptions = [
    ...
    {
        value: "Asian",
        label: "Asian (including Chinese, Indian, Japanese, Korean, Pakistani, any other Asian Background)",
    },
    {
        value: "Black",
        label: "Black (African, Caribbean, any other Black/African/Caribbean background)",
    },
    {
    ...
    {
        value: "White",
        label: "White (including Eastern/Northern European and any other White background)",
    },
    {
...
exports.sexualOrientationOptions = [
    ...
    {
        value: "Sexual Orientation Not Listed",
        label: "Sexual Orientation Not Listed",
    },
    { value: "Prefer Not to Answer", label: "Prefer Not to Answer" },
];
