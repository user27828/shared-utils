 ...
 */
export const FM_PURPOSE_POLICIES = {
    resume: {
 ...
 */
export const extractExtensionLower = (filename) => {
 ...
 */
export const validateFmUploadInputs = (input, policies = FM_PURPOSE_POLICIES) => {
    ...
    const mimeAllowed = policy.allowedMimeTypes.includes(mimeType) ||
