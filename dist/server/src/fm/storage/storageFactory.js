 ...
 */
import { assertValidFmServerConfig, resolveFmLocalUploadRootAbsPath, } from "../config.js";
 ...
 */
export const createFmStorage = async (config) => {
    ...
    try {
        ...
        if (isModuleNotFound) {
            throw new Error("FM S3 storage requires @aws-sdk/client-s3 and @aws-sdk/s3-request-presigner. " +
