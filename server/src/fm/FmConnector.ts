...
): connector is FmConnectorWithTransaction {
  return (
    typeof (connector as FmConnectorWithTransaction).withTransaction ===
    "function"
  );
}
...
export function hasBatchVariantDelete(
  connector: FmConnector,
): connector is FmConnectorWithBatchVariantDelete {
  return (
    typeof (connector as FmConnectorWithBatchVariantDelete)
