...
const assertSafeStorageRef = (ref: FmObjectRef): void => {
  if (!ref.bucket) {
...
const resolveUnderRoot = (rootAbs: string, ref: FmObjectRef): string => {
 ...
 */
export class FmStorageLocal implements FmStorageAdapter {
  private dataRootAbsPath: string;

  constructor(params: { dataRootAbsPath: string }) {
