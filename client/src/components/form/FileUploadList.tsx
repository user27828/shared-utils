...
export interface FileUploadListProps {
  ...
  loadList?: () =>
    ...
    | ModeUploadFileProps[]; // Function to load the list of existing files, if applicable
  uploadFile?: ({
    method,
    body,
  }: {
  ...
  fileExtensions?: string[] | string; // Acceptable file types
