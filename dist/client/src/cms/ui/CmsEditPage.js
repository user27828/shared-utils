...
const CmsEditPage = ({ uid: propUid, config, defaultPostType = "page", defaultLocale = "en", }) => {
    ...
    return (_jsxs(Container, { maxWidth: "xl", sx: { pt: 0, pb: 3 }, children: [_jsx(Box, { "aria-live": "polite", "aria-atomic": "true", sx: { position: "absolute", left: -9999 }, children: liveMessage }), _jsx(Box, { "aria-live": "assertive", "aria-atomic": "true", sx: { position: "absolute", left: -9999 }, children: liveErrorMessage }), _jsxs(Box, { sx: {
                    ...
                    minHeight: "calc(100vh - 64px)",
                                        ...
                                        loadedRevisionId, ". Changes have not been saved."] })), _jsxs(Stack, { direction: { xs: "column", lg: "row" }, spacing: 3, children: [_jsxs(Box, { sx: { flex: 1, minWidth: 0 }, children: [_jsxs(Stack, { direction: "row", sx: {
                                                    justifyContent: "space-between",
                                                    alignItems: "center",
                                                    flexWrap: "wrap",
                                                    gap: 1,
                                                    mb: 2,
                                                }, children: [_jsxs(Stack, { direction: "row", spacing: 1, sx: {
                                                            alignItems: "center",
                                                        ...
                                                        }, size: "small", fullWidth: true, autoFocus: true, onBlur: handleSlugBlur, onKeyDown: handleSlugKeyDown, sx: { maxWidth: { xs: "100%", md: 520 } }, helperText: "Used in the URL path. Leading '/' is optional.", slotProps: {
                                                            htmlInput: {
                                                                style: { fontFamily: "monospace" },
                                                            },
                                                        } }))] }), _jsxs(Paper, { variant: "outlined", sx: { overflow: "hidden" }, children: [_jsxs(Stack, { direction: "row", sx: {
                                                            alignItems: "center",
                                                            justifyContent: "space-between",
                                                            flexWrap: "nowrap",
                                                            gap: 1.5,
                                                            ...
                                                            bgcolor: "action.hover",
                                                                    ...
                                                                    minWidth: 0,
                                                                    flexShrink: 0,
                                                                }, children: [_jsxs(FormControl, { size: "small", sx: { minWidth: 110 }, children: [_jsx(InputLabel, { children: "Content" }), _jsxs(Select, { value: contentType, label: "Content", onChange: (e) => {
                                                            ...
                                                            mb: 1,
                                                                    ...
                                                                    alignItems: "center",
                                                                            ...
                                                                            : status === "trash"
                                                                                ? "error"
                                                                                : "default", variant: status === "published" ? "filled" : "outlined" }), status === "published" && (_jsx(Typography, { variant: "caption", noWrap: true, sx: {
                                                                            color: "text.secondary",
                                                                        }, children: publishedAtText }))] }), _jsxs(Stack, { direction: "row", spacing: 1, sx: {
                                                                    alignItems: "center",
                                                                    justifyContent: "space-between",
                                                                }, children: [_jsxs(Typography, { variant: "body2", children: ["Revisions: ", revisionsCount] }), _jsx(Button, { size: "small", variant: "outlined", startIcon: _jsx(HistoryIcon, { fontSize: "small" }), onClick: () => setHistoryDrawerOpen(true), disabled: historyDrawerOpen || revisionsCount === 0, children: "Browse" })] })] })), _jsx(Divider, { sx: { my: 1 } }), _jsxs(Stack, { spacing: 1, children: [!isNew && status !== "published" && status !== "trash" && (_jsx(Button, { variant: "contained", color: "success", fullWidth: true, onClick: handlePublish, disabled: isSaving, children: "Publish" })), !isNew && status !== "trash" && (_jsxs(Stack, { direction: "row", spacing: 1, children: [_jsx(Button, { variant: "outlined", color: "warning", fullWidth: true, onClick: handleTrash, disabled: isSaving, children: "Move to Trash" }), !lockedBy && (_jsx(Button, { variant: "outlined", startIcon: _jsx(LockIcon, {}), fullWidth: true, onClick: handleLock, disabled: isSaving, children: "Lock" })), lockedBy && (_jsx(Button, { variant: "outlined", startIcon: _jsx(LockOpenIcon, {}), fullWidth: true, onClick: handleUnlock, disabled: isSaving, children: "Unlock" }))] })), !isNew && status === "trash" && (_jsxs(_Fragment, { children: [_jsx(Button, { startIcon: _jsx(RestoreIcon, {}), fullWidth: true, onClick: handleRestore, disabled: isSaving, children: "Restore" }), _jsx(Button, { color: "error", startIcon: _jsx(DeleteForeverIcon, {}), fullWidth: true, onClick: handleDeletePermanently, disabled: isSaving, children: "Delete permanently" })] })), !isNew && status === "trash" && _jsx(Divider, {})] })] }), !isNew && (_jsx(Paper, { sx: { p: 2, mb: 2 }, children: _jsx(CmsContentNotes, { notes: contentNotes, onAddNote: handleAddContentNote, onRemoveNote: handleRemoveContentNote, disabled: isSaving }) })), config?.renderMediaPicker && (_jsxs(Paper, { sx: { p: 2, mb: 2 }, children: [_jsx(Typography, { variant: "subtitle2", sx: { mb: 1 }, children: "Media & SEO" }), _jsxs(Stack, { direction: "row", spacing: 1, sx: {
                                                            alignItems: "center",
                                                            mb: 1,
                                                        }, children: [_jsx(Typography, { variant: "caption", sx: { minWidth: 100 }, children: "Featured image:" }), _jsx(Typography, { variant: "caption", noWrap: true, sx: {
                                                                    color: "text.secondary",
                                                                    flex: 1,
                                                                }, children: featuredImageUid || "—" }), _jsx(Button, { size: "small", variant: "outlined", startIcon: _jsx(AddIcon, { fontSize: "small" }), onClick: chooseFeaturedImage, children: "Choose" }), featuredImageUid && (_jsx(Button, { size: "small", color: "error", onClick: () => updateOptionsJson((o) => {
                                                                    delete o.featured_image_file_uid;
                                                                }), children: "Clear" }))] }), _jsxs(Stack, { direction: "row", spacing: 1, sx: {
                                                            alignItems: "center",
                                                            mb: 1,
                                                        }, children: [_jsx(Typography, { variant: "caption", sx: { minWidth: 100 }, children: "OG image:" }), _jsx(Typography, { variant: "caption", noWrap: true, sx: {
                                                                    color: "text.secondary",
                                                                    flex: 1,
                                                                }, children: ogImageUid || "—" }), _jsx(Button, { size: "small", variant: "outlined", startIcon: _jsx(AddIcon, { fontSize: "small" }), onClick: chooseOgImage, children: "Choose" }), ogImageUid && (_jsx(Button, { size: "small", color: "error", onClick: () => updateOptionsJson((o) => {
                                                                    if (o.seo) {
                                                                        delete o.seo.og_image_file_uid;
                                                                    }
                                                                }), children: "Clear" }))] }), _jsx(Divider, { sx: { my: 1 } }), _jsx(Typography, { variant: "caption", sx: { mb: 0.5, display: "block" }, children: "Attachments" }), attachments.map((att, idx) => (_jsxs(Stack, { direction: "row", spacing: 1, sx: {
                                                            alignItems: "center",
                                                            mb: 0.5,
                                                        }, children: [_jsx(Typography, { variant: "caption", noWrap: true, sx: {
                                                                    color: "text.secondary",
                                                                    flex: 1,
                                                                }, children: att.file_uid }), _jsx(IconButton, { size: "small", onClick: () => removeAttachment(idx), children: _jsx(DeleteIcon, { fontSize: "small" }) })] }, idx))), _jsx(Button, { size: "small", startIcon: _jsx(AddIcon, {}), onClick: addAttachment, children: "Add attachment" })] }))] })] })] })] }), isLoading && (_jsx(Box, { sx: {
                    position: "fixed",
                    inset: 0,
                    display: "flex",
                    alignItems: "center",
