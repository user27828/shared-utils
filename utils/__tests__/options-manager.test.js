  ...
  describe('GlobalOptionsManager', () => {
    ...
    describe('setGlobalOptions()', () => {
      ...
      test('should ignore options for unregistered utilities', () => {
        ...
        expect(optionsManager.getRegisteredUtilities()).not.toContain('nonexistent');
      });

      test('should handle empty options object', () => {
        const manager1 = new OptionsManager('util1', { value: 'default' });
        optionsManager.registerManager('util1', manager1);
        
        const originalValue = manager1.getOptions().value;
        
        optionsManager.setGlobalOptions({});
        
        expect(manager1.getOptions().value).toBe(originalValue);
      });
    });
