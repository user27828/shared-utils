...
export const getMeetingProvider = (key) => MEETING_PROVIDERS.find((p) => p.key === key);
/** Create a fresh MeetingEntry with empty values for the given provider */
export const createMeetingEntry = (providerKey = "zoom") => {
 ...
 */
export const flattenMeetingEntries = (entries) => {
    const result = [];
