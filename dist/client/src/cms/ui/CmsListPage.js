...
const CmsListPage = ({ config, activeTab: controlledTab, onTabChange, searchQuery: controlledSearch, onSearchChange, }) => {
    ...
    // ── Render ────────────────────────────────────────────────────────────
    return (_jsxs(Container, { maxWidth: "lg", sx: { py: 3 }, children: [_jsxs(Stack, { direction: "row", sx: { mb: 2, justifyContent: "space-between", alignItems: "center" }, children: [_jsx(Typography, { variant: "h5", children: "CMS Content" }), _jsxs(Stack, { direction: "row", spacing: 1, children: [_jsx(Tooltip, { title: "Refresh", children: _jsx(IconButton, { onClick: () => void load(), children: _jsx(RefreshIcon, {}) }) }), _jsx(Button, { variant: "contained", startIcon: _jsx(AddIcon, {}), onClick: () => nav?.goToCreate?.(), children: "New" })] })] }), _jsxs(Paper, { sx: { mb: 2 }, children: [_jsx(Stack, { direction: "row", sx: { px: 2, pt: 1, alignItems: "center" }, children: _jsx(TextField, { size: "small", placeholder: "Search...", value: q, onChange: (e) => setQ(e.target.value), slotProps: {
                                input: {
