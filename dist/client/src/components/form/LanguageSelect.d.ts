 ...
 * @returns {JSX.Element}
 */
declare function LanguageSelect({ value, onChange, multiple, topLanguages, showEmpty, searchable, sortBy, order, label, id, name, required, disabled, error, helperText, sx, fullWidth, size, variant, placeholder, ...props }: {
    value: string | string[];
    onChange: Function;
    multiple: boolean;
