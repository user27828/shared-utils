...
export interface FmApiFunctions {
  ...
  fmGetFileApi: (input: { fileUid: string }) => Promise<FmFileRow>;
  ...
  fmArchiveFileApi: (input: { fileUid: string }) => Promise<FmFileRow>;

  fmRestoreFileApi: (input: { fileUid: string }) => Promise<FmFileRow>;
  ...
  fmListVariantsApi: (input: {
    fileUid: string;
  }) => Promise<{ items: FmFileVariantRow[] }>;
  ...
  fmGetVariantProxyUploadUrl: (input: { variantUid: string }) => string;

  fmGetPublicMediaUrl: (input: { fileUid: string }) => string;
}
 ...
 */
export function createFmApiFunctions(api: FmApi): FmApiFunctions {
  return {
    // ── Upload ────────────────────────────────────────────────────────
    ...
    fmListFilesApi: (params) => api.listFiles(params as any),
    ...
    fmGetVariantProxyUploadUrl: (input) =>
      api.getVariantProxyUploadUrl(input.variantUid),
